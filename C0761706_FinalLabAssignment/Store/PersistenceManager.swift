...
class PersistenceManager {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "C0761706_FinalLabAssignment")
    ...
    func search<T: NSManagedObject>(type: T.Type, keyword: String, completion: @escaping(_: [T]) -> Void) {
        ...
        let predicate = NSPredicate(format: "name contains[cd] %@ OR desc contains[cd] %@", keyword, keyword)
